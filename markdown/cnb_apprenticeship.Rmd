...
packages <- c("lfe", "lme4", "plm", "bookdown", "gtsummary", "labelled", "grid", "gridExtra", "rstatix", "kableExtra")
...
```{r, fig-firmhist, fig.height=9, out.width="100%", fig.cap = "Truncated distributions of net benefits per firm"}
```
